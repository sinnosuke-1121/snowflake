...
4. **Public**を選択(無料のGitHub PagesはPublicリポジトリのみ)
   - Privateにしたい場合はNetlify/Vercel/GitHub Pro($4/月)を使ってください
5. 「Create repository」をクリック
6. 「uploading an existing file」をクリック
7. このフォルダ内の **すべてのファイル**(`index.html`, `bundle.js`, `manifest.json`, `sw.js`, `icon-*.png`)をドラッグ&ドロップ
...
- レビューモード(全問解説確認)
- 自分で問題を追加可能
- **クイズの中断と再開**: クイズ途中で閉じても、ホーム画面に「続きから」ボタンが表示され、現在の問題番号・スコアから再開可能
